<template><h1 id="colors-and-theming" tabindex="-1"><a class="header-anchor" href="#colors-and-theming" aria-hidden="true">#</a> Colors and Theming</h1>
<p>USWDS has an amazing and extensive system for dealing with colors, which is detailed <a href="https://designsystem.digital.gov/design-tokens/color/overview/" target="_blank" rel="noopener noreferrer">here<ExternalLinkIcon/></a>. USWDS in general is designed to be a super flexible framework, but this can be a overwhelming. Drawing inspiration from <a href="https://getbootstrap.com/" target="_blank" rel="noopener noreferrer">Bootstrap<ExternalLinkIcon/></a>, uswds-vue instead uses a simple color theme which makes it much simpler to manage and keep colors consistent across all of the components. But you can always go deeper and apply the color styles from USWDS manually.</p>
<h2 id="variants" tabindex="-1"><a class="header-anchor" href="#variants" aria-hidden="true">#</a> Variants</h2>
<p>The basis for the theming setup in uswds-vue is <code>variants</code>. There are {{btnVariants.length}} variants, and these are applied to <em>every</em> component to keep a consistent look and make themeing much simpler.</p>
...
<h2 id="theme-playground" tabindex="-1"><a class="header-anchor" href="#theme-playground" aria-hidden="true">#</a> Theme Playground</h2>
<div class="mt-3 mb-3 usx-color-docs">  
