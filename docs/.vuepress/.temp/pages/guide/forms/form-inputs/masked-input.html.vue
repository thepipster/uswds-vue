<template><div><h1 id="masked-input" tabindex="-1"><a class="header-anchor" href="#masked-input"><span>Masked Input</span></a></h1>
<p>A version of the <code v-pre>&lt;us-form-input&gt;</code> exists with masking, this allows for guided user input for things that require specific struct. For example; phone numbers, zip codes, social security numbers, etc.</p>
<p>This component uses the 3rd party library <a href="https://vuejs-tips.github.io/vue-the-mask/" target="_blank" rel="noopener noreferrer">vue-the-mask</a>, and supports any of the masks shown <a href="https://vuejs-tips.github.io/vue-the-mask/" target="_blank" rel="noopener noreferrer">here</a>.</p>
<div class="mb-3 mt-3">
...
<h2 id="tokens" tabindex="-1"><a class="header-anchor" href="#tokens"><span>Tokens</span></a></h2>
...
<h2 id="custom-tokens" tabindex="-1"><a class="header-anchor" href="#custom-tokens"><span>Custom tokens</span></a></h2>
...
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>us-form-input-masked</span> <span class="token attr-name">mask</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>FFFFF<span class="token punctuation">"</span></span> <span class="token attr-name">placeholder</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>Enter a hex value<span class="token punctuation">"</span></span></span>
<span class="line">    <span class="token attr-name">:tokens</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{</span>
<span class="line">        F: {</span>
<span class="line">            pattern: /[0-9a-fA-F]/,</span>
<span class="line">            transform: v => v.toLocaleUpperCase()</span>
<span class="line">        }</span>
<span class="line">    }<span class="token punctuation">"</span></span></span>
<span class="line">    <span class="token attr-name">v-model</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>testToken<span class="token punctuation">"</span></span></span>
<span class="line"><span class="token punctuation">/></span></span></span>
